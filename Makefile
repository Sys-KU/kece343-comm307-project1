...
test: $(TARGET) test_0 test_1 test_2 test_3 test_4 test_5 test_6 test_7 test_8
...
test_8: $(TARGET)
	...
	./$(TARGET) sample_input/example8.s; \
	diff -Naur sample_input/example8.o sample_output/example8.o; \
	if [ $$? -eq 0 ]; then echo "\tTest seems correct\n"; else echo "\tResults not identical, check the diff output\n"; fi
